...
export const recipes:Recipe[]=[
  {
    ...
    sections:false,
    scene:{camera:{perspective:1800,...surveyPose,x:-100,y:0,z:-610},focus:{distance:1498,fStop:5.6,maxBlur:6},nodes:[{id:"dashboard"}]},
  ...
  },
  {
    ...
    sections:true,
    scene:{camera:{perspective:1800,...platingPose,x:210,y:-50,z:-360},focus:{distance:1440,fStop:5.6,maxBlur:6},nodes:[{id:"dashboard"},{id:"sidebar",parentId:"dashboard"},{id:"header",parentId:"dashboard"},{id:"metrics",parentId:"dashboard"},{id:"chart",parentId:"dashboard"},{id:"table",parentId:"dashboard"}]},
  ...
  },
  {
    ...
    sections:true,
    scene:{camera:{perspective:1800,...floatingPose,x:120,y:80,z:-330},focus:{distance:1220,fStop:5.6,maxBlur:6},nodes:[{id:"dashboard"},{id:"sidebar",parentId:"dashboard"},{id:"header",parentId:"dashboard"},{id:"metrics",parentId:"dashboard"},{id:"chart",parentId:"dashboard",transform:{z:190}},{id:"table",parentId:"dashboard"}]},
