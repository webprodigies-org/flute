...
Use the installed \`@flute/scene\` and \`@flute/scene/preview\` exports and their TypeScript declarations for the exact API. This app's recipe directory is \`src/flute/scenes\`; read capabilities.api.recipes in the guide for its file contract.
