...
function ExportMenu({disabled}: {disabled: boolean}) {
  ...
  return disabled ? <button className="flute-control" disabled><Glyph kind="export"/>Export</button> :
    <details className="flute-export"><summary className="flute-control flute-primary"><Glyph kind="export"/>Export</summary>
      <div className="flute-export-panel flute-chrome"><strong>Export your scene</strong>
...
export function ScenePreview({definition: input, children, title = "Untitled scene", backHref, revision, hot}: ScenePreviewProps) {
  ...
  return <main data-flute-preview="" data-flute-state={blocked ? "unavailable" : "ready"}>
    ...
    <header className="flute-header flute-chrome">
      <div className="flute-brand"><span className="flute-mark" aria-hidden="true"/>flute</div>
      <h1 className="flute-title">{title}</h1>
      <div className="flute-actions">{backHref && <a className="flute-control" href={backHref}>Back to app</a>}<ExportMenu disabled={blocked || !session.durationMs}/></div>
    </header>
    ...
    <div className="flute-viewport" ref={viewport} aria-label="Scene preview">
      {definition ? <div className="flute-canvas" data-flute-capture="scene" data-flute-valid={blocked ? "false" : "true"}
      ...
      </div> : <div className="flute-empty flute-chrome">
        ...
        <details className="flute-onboarding"><summary className="flute-control flute-primary">Get started</summary>
    ...
    <footer className="flute-footer flute-chrome">
